...
<div class="row py-3">
    ...
    <form action="#" class="col-lg-6 py-5 needs-validation" id="form" method="post" novalidate>
        ...
        <div class="form-group">
            <input type="password" class="form-control rounded-pill" autofocus placeholder="Contraseña" id="txt" name="registrarContraseña" required>
            <div class="valid-feedback">Valido</div>
            <div class="invalid-feedback">El campo no puede quedar vacio.</div>
        </div>
        <div class="form-group">
        ...
        if (isset($_POST["registrarContraseña"])) {
            ...
            if ($regCon == $regConC) {
                ...
                if ($registro == "error") {
                    echo '<div class="alert alert-danger">No usar caracteres especiales</div>';
                }
            }else{
