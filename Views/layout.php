        ...
        <div class="bg-white border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                <?php if($user == ""):?>
                    ...
                    <a href="index.php" class="list-group-item list-group-item-action" id="flush"><h3 class="font-weight-bold">Catálogo</h3></a>
                ...
                <?php elseif($user["idROL_FK"] == 2):?>
                    ...
                    <a href="index.php?paginasAdministradores=RegistroPedido" id="flush" class="list-group-item list-group-item-action"><h3>Registrar Pedido</h3></a>
                    <a href="#" class="list-group-item list-group-item-action" id="flush">
                        <h2>Precio</h2>
                        <form method="post" action="">
                            $<input type="text" name="pMinimo" placeholder="Minimo">
                ...
                <div class="collapse navbar-collapse col-lg-11" id="navbarSupportedContent">
                    <ul class="navbar-nav col-lg-12">
                        <li class="nav-brand col-lg-1">
                            <a href="index.php">
                                <img class="d-inline-block align-top pull-left" width="70" height="50"
                                src="Assets/img/Contraste4.jpg">
                            </a>
                        </li>
                        <li class="nav-brand col-lg-7">
                            <i class="fas fa-search"></i><input type="text" id="bqd" placeholder="¿Qué estás buscando?">
                        </li>
                        <li id="op1" class="nav-item col"><a href="index.php?paginasCliente=CarritoVacio" id="nab">Ir al carrito<i class="fas fa-cart-plus"></i></a></li>
                        <?php if($user == ""):?>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                ...
                if (isset($_GET["paginasCliente"])) {
                    ...
                    if ($_GET["paginasUsuario"] == "InicioSesion" ||
